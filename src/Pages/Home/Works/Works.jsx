    ...
    return (
        <div className="work-container m-0">
            <div className="work-section margins paddings flex flex-col justify-center items-center">
                <div className="work-intro xl:w-2/5 md:w-2/3 text-center mb-8">
                ...
                <div className="strategy-part grid xl:grid-cols-4 md:grid-cols-2 p-[1%] text-center">
                    <div className="select-car m-[1%]">
