    ...
    return (
        <div className="number-container bg-cover" style={{backgroundImage:`url(${background})`}}>
            <div className="number-section paddings margins">
                ...
                <div className="number-info flex justify-between mt-7">
                    <div className='flex w-1/6 items-center justify-center rounded-xl  bg-slate-100 h-[80px] border-2 border-orange-500'>
