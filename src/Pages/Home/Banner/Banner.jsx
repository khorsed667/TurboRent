            ...
            <div className="banner-section flex justify-center xsm:py-8 lg:py-0 xl:mx-10">
                <div className="text-area flex flex-row w-full items-center md:w-1/2">
                    <div className="theme-text  flex-row items-center p-4">
                        ...
                        <div className='xl:text-5xl md:text-2xl xsm:text-lg font-bold md:my-2 text-black'>Enjoy your dream with </div> 
                        <div className='xl:text-5xl md:text-2xl xsm:text-lg font-bold md:my-2 text-orange-500'> our exciting Wheels</div>
